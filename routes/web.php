...
Route::prefix('admin')->middleware('auth')->namespace('Admin')->group(function(){
    ...
    Route::get('unidade', [UnidadeController::class, 'index'])->name('unidades');
    ...
    Route::get('unidade/conviteNova', [UnidadeConvitesController::class, 'conviteNova'])->name('uniade-convidar-nova');
    ...
    Route::get('unidade/{id}/restore', [UnidadeController::class, 'restore'])->name('unidade-restore');
    // Route::get('unidades/gestor/new', 'UsuarioController@newGestor')->name('usuario-new-gestor');
    Route::get('unidade/gestor/new', [UsuarioController::class, 'newGestor'])->name('usuario-new-gestor');
