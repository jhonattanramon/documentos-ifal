...
<head>
    ...
    <title>Bem vindo ao Documentos IFAL</title>
                        ...
                        <td valign="top" id="templateBody" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #FFFFFF;border-top: 0;border-bottom: 2px solid #EAEAEA;padding-top: 0;padding-bottom: 9px;">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0;mso-table-rspace: 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" class="mcnTextContentContainer">
                                            ...
                                            <tr>
                                                <td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                                                    <p style="text-align: center; margin: 10px 0;padding: 0; mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;">Seja bem vindo(a)</p>
                                                    <h1 style="text-align: center;display: block;margin-top: -35px;padding: 0;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;color:#12586f"><br/>{{$name}}<br></h1>
                                                    <p style="text-align: center; margin: 10px 0;padding: 0; mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;">Você foi adicionado(a) ao Portal Normativas como:<br/> <strong>{{$tipo}}</strong><br/> representando o<br/> <strong>{{$unidade}}</strong><br/> Aqui estão seus dados de acesso:<br></p>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonBlock mcnTableAux">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="text-align:center;margin:10px 0;padding:0;color:#202020;font-family:Helvetica;font-size:16px;line-height:150%">Para conhecer mais sobre a plataforma,<br/>acesse nosso guia em vídeo através do botão "Guia" na página inicial</p>
                                        </td>
                                    </tr>                                                                                                                                 
                                </tr>
                                </tbody>
