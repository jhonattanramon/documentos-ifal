    ...
    <div class="col-lg-12">
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Documentos pendentes recentes - Edite e resolva as pendências para publicá-los</h3>
            </div>
                <!-- /.box-header -->
                            ...
                            <tr @if ($doc->isBaixado()) class='bg-warning' @else class='bg-danger' @endif>
                                ...
                                <td>
                                    <span class="badge bg-info">
                                        {{$doc->tipoDocumento ? $doc->tipoDocumento->nome : 'Sem tipo documento'}}
                                    </span>
                                </td>
                                <td>
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Top documentos mais baixados</h3>
            </div>
                <!-- /.box-header -->
            <div class="box-body no-padding">
                <table class="table table-condensed table-hover table-striped">
                    ...
                    @foreach($downloads as $d)
                        <tr>    
                            ...
                            <td>{{date('d-m-Y', strtotime($d->data_publicacao))}}</td>
                            <td>
                                {{$d->ementa}}
                            </td>
                            <td>
                            ...
                            <td>
                                <a  target="_blank"  href="{{route('pdfNormativa',$d->arquivo)}}" title="Download">
                                    <i class="fa fa-cloud-download"></i>
                                </a>
                                <a href="{{ route("documento",$d->id) }}" title="Visualizar">
                                    <i class="fa fa-eye fa-2x" ></i>
                                </a>
                                <a href="{{ route("documento-edit",$d->id) }}" title="Editar">
                                    <i class="fa fa-edit fa-2x" ></i>
                                </a>
                            </td>
                        </tr>
